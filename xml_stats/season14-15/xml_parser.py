...
with open("season_stats.json", "wb") as f:
    json.dump(season_match_stats_dict, f, indent=4, separators=(',', ':'), encoding="utf-8")

with open("season_match_stats.json", "wb") as f:
    json.dump(season_match_details_dict, f, indent=4, separators=(',', ':'), encoding="utf-8")
